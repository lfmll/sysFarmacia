...
class AccionSeeder extends Seeder
{
    ...
    public function run()
    {
        $clases = [
            ...
            ['nombre'=>'(A04) Anteméticos y antinauseosos','clase'=>'(A) Tracto alimentario y metabolismo'],
            ...
            ['nombre'=>'(A07) Antidiarreicos, susbs. de electrolitos orales y antiiflamatorios intestinales','clase'=>'(A) Tracto alimentario y metabolismo'],
            ...
            ['nombre'=>'(B02) Coagulantes del sistema sanguíneo','clase'=>'(B) Sangre y aparato hematopoyético'],
            ...
            ['nombre'=>'(C04) Vasoterapia cerebral periférica','clase'=>'(C) Sistema cardiovascular'],
            ['nombre'=>'(C05) Preparados antivariciosos - antihemorroides','clase'=>'(C) Sistema cardiovascular'],
            ['nombre'=>'(C07) Agentes beta bloqueadores','clase'=>'(C) Sistema cardiovascular'],
            ...
            ['nombre'=>'(C010) Preparaciones antiateroma/Reguladoras de lípidos','clase'=>'(C) Sistema cardiovascular'],
            ['nombre'=>'(C011) Productos para la terapia múltiple cardiovascular','clase'=>'(C) Sistema cardiovascular'],
            ...
            ['nombre'=>'(G01) Antiinfecciosos ginecológicos','clase'=>'(G) Sistema genitourinario y hormonas sexuales'],
            ...
            ['nombre'=>'(H01) Hormonas pituitarias e hipolatánicas','clase'=>'(H) Hormonales sistémicos'],
            ['nombre'=>'(H01) Corticosteroides sistémicos simples','clase'=>'(H) Hormonales sistémicos'],
            ['nombre'=>'(H01) Terapia tiroidea','clase'=>'(H) Hormonales sistémicos'],
            ['nombre'=>'(H01) Otras hormonas','clase'=>'(H) Hormonales sistémicos'],
            ...
            ['nombre'=>'(M05) Otras drogas para trastornos del sistema musculoesqueléticos','clase'=>'(M) Sistema músculo esquelético'],
            ...
            ['nombre'=>'(P01) Antiprotozoarios y antihelmínticos','clase'=>'(P) Parasitología'],
